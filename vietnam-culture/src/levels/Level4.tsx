...
export default function Level4({ bundle, onBack, onComplete }: { bundle: Bundle; onBack: () => void; onComplete?: (summary: { levelId: "level4"; ms: number; completedAt: string }) => void }) {
  ...
  }, [done, playWin, stopHintSequence, onComplete, ms]);
